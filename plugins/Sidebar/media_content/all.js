...
(function() {
  ...
  Sidebar = (function() {
    function Sidebar(wrapper_key) {
      this.ws = new ZeroWebsocket(wrapper_key);
      this.ws.route = this.route;
      this.update();
    }

    Sidebar.prototype.route = function(message) {
    ...
    Sidebar.prototype.update = function() {
      ...
      return this.ws.cmd("sidebarGetHtmlTag", [], function(html) {
        var is_first_time, options;
        options = {};
        is_first_time = tag.children.length === 0;
        if (is_first_time) {
          options.onBeforeMorphEl = function(from_el, to_el) {
            return from_el.className !== "globe" && !from_el.classList.contains("noupdate");
          };
        }
    ...
    Sidebar.prototype.setup = function() {
      var menu;
      this.onClick("#checkbox-owned", ((function(_this) {
        return function() {
      ...
      this.onClick("#button-sitelimit", ((function(_this) {
        return function() {
      ...
      this.onClick("#button-autodownload_bigfile_size_limit", ((function(_this) {
        return function() {
      ...
      this.onClick("#button-dbreload", ((function(_this) {
        return function() {
      ...
      this.onClick("#button-dbrebuild", ((function(_this) {
        return function() {
      ...
      this.onClick("#button-update", ((function(_this) {
        return function() {
      ...
      this.onClick("#button-pause", ((function(_this) {
        return function() {
      ...
      this.onClick("#button-resume", ((function(_this) {
        return function() {
      ...
      this.onClick("#button-delete", ((function(_this) {
        return function() {
      ...
      this.tag.find("#checkbox-owned").on("click touchend", (function(_this) {
        return function() {
          return _this.wrapper.ws.cmd("siteSetOwned", [_this.tag.find("#checkbox-owned").is(":checked")]);
        };
      })(this));
      this.tag.find("#checkbox-autodownloadoptional").on("click touchend", (function(_this) {
        return function() {
          return _this.wrapper.ws.cmd("siteSetAutodownloadoptional", [_this.tag.find("#checkbox-autodownloadoptional").is(":checked")]);
        };
      })(this));
      this.tag.find("#button-identity").on("click touchend", (function(_this) {
        return function() {
          _this.wrapper.ws.cmd("certSelect");
          return false;
        };
      })(this));
      this.tag.find("#button-settings").on("click touchend", (function(_this) {
        return function() {
      ...
      this.tag.find("#link-directory").on("click touchend", (function(_this) {
        return function() {
          _this.wrapper.ws.cmd("serverShowdirectory", ["site", _this.wrapper.site_info.address]);
          return false;
        };
      })(this));
      this.tag.find("#link-copypeers").on("click touchend", (function(_this) {
        return function(e) {
      ...
      this.tag.find(".contents-content").on("click touchend", (function(_this) {
        return function(e) {
      ...
      this.tag.find("#menu-sign-publish").on("click touchend", (function(_this) {
        return function() {
      ...
      this.tag.find("#button-sign-publish").on("click touchend", (function(_this) {
        return function() {
          var inner_path;
          inner_path = _this.tag.find("#input-contents").val();
          _this.wrapper.ws.cmd("fileRules", {
      ...
      $(tag).find("#privatekey-add").on("click touchend", (function(_this) {
        return function(e) {
      ...
      $(tag).find("#privatekey-forget").on("click touchend", (function(_this) {
        return function(e) {
...
(function() {
  ...
  ZeroWebsocket = (function() {
    function ZeroWebsocket(wrapper_key) {
      ...
      this.ws_url = origin + "/ZeroNet-Internal/Websocket?wrapper_key=" + wrapper_key;
